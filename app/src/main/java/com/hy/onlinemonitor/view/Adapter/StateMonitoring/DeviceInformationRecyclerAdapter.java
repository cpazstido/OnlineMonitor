...
//装置信息
public class DeviceInformationRecyclerAdapter extends RecyclerView.Adapter<StateMonitoringViewHolder> {
    private final Context mContext;
    private List<DeviceInformation> mList;

    public DeviceInformationRecyclerAdapter(Context mContext, List<DeviceInformation> mList) {
    ...
    public StateMonitoringViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_cm, parent, false);
